        ...
        <% string[] DashCount = (string[])SeedSpeak.Util.SessionStore.GetSessionValue(SeedSpeak.Util.SessionStore.DashboardCount); %>
            <div id="navigation">
                <ul>
                    ...
                    <li class="curr"><a href="/SeedStream/ListStreams">My Feeds/Lists (<%=DashCount[1] %>)</a> </li>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td class="commontxt">
                                                <a style="cursor:pointer;" onclick="javascript:callNewStreamWindow()">Create a feed</a> by entering custom search criteria to discover ideas as they are planted, or <a style="cursor:pointer;" onclick="javascript:callMiniStreamWindow()">create a handpicked list</a> of Seeds instead.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="shade">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td align="left" style="width: 240px">
                                                    <% using (Html.BeginForm("ListStreams", "SeedStream", FormMethod.Post, new { id = "ListStreamForm" }))
                                                       { %>                                                    
                                    ...
                                    <div id="sort">
                                        <table style="width: auto; margin-top: -2px">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Proximity">Proximity</a>
                                                </td>
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Date">Date</a>
                                                </td>
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Category">Category</a>
                                                </td>
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Likes">Likes</a>
                                                </td>
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Comments">Comments</a>
                                                </td>
                                                <td>
                                                    <a href="/SeedStream/ListStreams/Seed Replies">Seed Replies</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
