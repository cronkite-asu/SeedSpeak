...
<asp:Content ID="Content4" ContentPlaceHolderID="subpageContainer" runat="server">
    <table>
        ...
        <tr>
            ...
            <% if (mData != null)
               { %>
                <a style="cursor:pointer;" onclick="javascript:callNewStreamWindow()">Create a feed</a> to discover the latest Seeds as they are planted based on your custom search criteria. Want to handpick your favorite ideas instead? <a style="cursor:pointer;" onclick="javascript:callMiniStreamWindow()">Create a list</a> of Seeds.
                <%}
               else
               { %>
               <a style="cursor:pointer;" onclick="javascript:callLoginPartialWindow(0)">Create a feed</a> to discover the latest Seeds as they are planted based on your custom search criteria. Want to handpick your favorite ideas instead? <a style="cursor:pointer;" onclick="javascript:callLoginPartialWindow(0)">Create a list</a> of Seeds.
                <%} %>
            </td>
        </tr>
        <tr>
    ...
    <div class="subpgtext">
        <div class="stream_searchbar">
            <%using (Html.BeginForm("Feeds", "Home", FormMethod.Post, new { enctype = "multipart/form-data", id = "feedForm" }))
              {%>
            <div class="searchbar">
                <span></span>
                <input type="text" id="feedSearch" name="feedSearch" class="waterMark" title="SEARCH ALL FEEDS BY: Title, description, location, etc." />
                <input type="submit" value="" class="go1" style="float: none;" />
                <input type="button" value="" class="reset" onclick="window.location = '/Home/Feeds';" />
            </div>
            ...
            <tr>
                <td valign="top">
                    <div class="tabgridcontent">
                        ...
                        %>
                        <div class="desc">
                            Nearby feeds matching your search:
                            <%=ViewData["SearchTerm"]%></div>
...
if (c.description.Length > 250)
{
    ...
    Response.Write(subString); %>
      ...
      .Render();
                                               ...
                                               {
                                                   Response.Write("<div class='errpgmessage'>No feeds found for your search criteria</div>");
                                               }
                                           }
                            %>
                        </div>
                        ...
                        %>
                        <div class="desc">
                            Latest feeds matching your search: Latest Feeds</div>
                        <div class="streamfull">
                            <% 
                                           if (ViewData["LatestStreams"] != null)
                                           {
                                               IList<SeedSpeak.Model.ssStream> objLatestStream = (List<SeedSpeak.Model.ssStream>)ViewData["LatestStreams"];
...
if (c.description.Length > 250)
{
    ...
    Response.Write(subString); %>
      ...
      .Render();
                                               ...
                                               {
                                                   Response.Write("<div class='errpgmessage'>No latest feeds found</div>");
                                               }
                                           }
                            %>
                        </div>
                        ...
                        %>
                        <div class="desc">
                            Popular feeds matching your search: Most Popular Feeds</div>
                        <div class="streamfull">
                            <% 
...
if (c.description.Length > 250)
{
    ...
    Response.Write(subString); %>
      ...
      .Render();
                                               ...
                                               {
                                                   Response.Write("<div class='errpgmessage'>No most popular feeds found</div>");
                                               }
                                           }
                            %>
                        </div>
